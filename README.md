...
В методе <b>public int sumLastNums (int x):</b> в переменную <b>c</b> записываю позледние цифры числа, сумму которых просят найти. Возращаю сумму, которую нахожу при помощи делений разных видов.
