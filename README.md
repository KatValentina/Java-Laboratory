...
В методе main происходит проверка, чтобы введённый год пользователем был строго больше 0 (или строго меньше 140) и после этой проверки вызывается метод <b>public String age (int x);</b>. В нём находится последняя цифра года, а далее:<br>
