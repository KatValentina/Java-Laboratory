...
В цикле <b>for (int i=0;i<3;i++)</b> обнавляется переменная <b>a</b> (туда как раз вносится сумма чисел из разряда едениц), а также обновляется переменная <b>b</b><br>
...
2) Находим числа из разряда едениц<br>
...
3) Находим сумму чисел из разряда едениц и возвращаем её в переменную <b>a</b><br>.
